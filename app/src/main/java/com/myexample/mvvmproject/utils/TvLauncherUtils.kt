...
class TvLauncherUtils private constructor() {
    companion object {
        ...
        @Synchronized fun upsertChannel(
            ...
            val host = context.getString(R.string.app_name)
            ...
            val channelLogoUri =
                    collection.artUri ?: resourceUri(context.resources, R.mipmap.ic_launcher)
        ...
        @Synchronized fun upsertWatchNext(context: Context, metadata: TvMediaMetadata): Long? {
            ...
            programBuilder.setIntentUri(Uri.parse(
                    "https://${context.getString(R.string.app_name)}/program/${metadata.id}"))
